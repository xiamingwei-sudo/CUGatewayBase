...
typedef void (^PNUdpTracerouteHandler)(NSMutableString * _Nullable info);

typedef void (^PNUdpTracerouterIpArrHandler)(NSArray * _Nullable ipArr);
 ...
 */
+ (instancetype _Nullable )start:(NSString * _Nonnull)host
...
+ (instancetype _Nullable )startAndCompleteIparr:(PNUdpTracerouterIpArrHandler _Nonnull)complete;

+ (instancetype _Nullable )start:(NSString *_Nonnull)host maxTtl:(NSUInteger)maxTtl completeIparr:(PNUdpTracerouterIpArrHandler _Nonnull)complete;
